          ...
          <div className="flex justify-center rounded-2xl bg-gradient-to-r from-[#fafbff] to-[#eff1fe] px-8 py-[60px]">
            <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-start lg:gap-6">
              ...
              <div className="relative shrink-0">
                <pre className="h-[427px] w-[378px] overflow-hidden rounded-[17.5px] bg-[#11162b] px-[22px] py-[31px] font-[family-name:var(--font-mono)] text-[14.25px] leading-[19.7px] shadow-[0_13px_13px_rgba(15,23,42,0.15)]">
                  <code>
                    {CODE.map((line, index) => (
                ...
                <div className="absolute -top-8 left-[329px] flex size-[92px] h-[101px] flex-col items-center justify-center gap-2 rounded-[17.5px] bg-[#5d45f9] p-3 shadow-[0_11px_9px_rgba(79,70,229,0.25)]">
              ...
              <div className="flex items-center">
                ...
                <div className="flex flex-col items-center">
                  <div className="flex h-[120px] w-[230px] flex-col items-center justify-center gap-1 rounded-[15px] border border-[#e2e8f0] bg-white p-4 shadow-[0_9px_9px_rgba(99,102,241,0.07)]">
                  ...
                  <div className="flex w-[379px] justify-between px-[58px]">
                    {PLATFORMS.map(({ key }) => (
                      <span key={key} aria-hidden className="h-[22px] w-px border-l border-dashed border-[#94a3b8]" />
                    ))}
                  </div>
                  <div className="-mt-[22px] w-[263px] border-t border-dashed border-[#94a3b8]" aria-hidden />
                  <div className="mt-[22px] flex gap-3">
                    {PLATFORMS.map(({ key, icon }) => (
                      <div
                        key={key}
                        className="flex h-[126px] w-[117px] flex-col items-center justify-center gap-3 rounded-[13px] bg-white pb-4 pt-5 shadow-[0_7px_7px_rgba(15,23,42,0.05)]"
                      >
